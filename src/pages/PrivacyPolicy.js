...
const PrivacyPolicy = () => (
  <div className="max-w-4xl mx-auto prose prose-lg">
    <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8 rounded-r-lg">
      ...
      <p className="text-blue-700 mb-0">Last Updated: Jan 2026</p>
    </div>

    <div className="bg-white p-8 rounded-xl shadow-lg">
      <h2 className="text-2xl font-semibold text-gray-800 mb-4">1. Introduction</h2>
      <p className="text-gray-600 mb-6">
        Banor Capital Limited ("we," "our," or "us") operates banorcapital.com and owns and manages
        <strong> Clopad Technologies</strong>, a project management and ticketing platform.
        Both Banor Capital and Clopad Technologies use Meta’s Business API to provide secure authentication
        services via WhatsApp. This Privacy Policy explains how we collect, use, and protect
        your personal information across our platforms.
      </p>

      <h2 className="text-2xl font-semibold text-gray-800 mb-4">2. Information We Collect</h2>
      <h3 className="text-xl font-medium text-gray-700 mb-3">2.1 Phone Numbers</h3>
      <p className="text-gray-600 mb-4">
        • We collect your phone number when you attempt to log in to our platforms<br/>
