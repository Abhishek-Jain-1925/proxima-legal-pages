    ...
    <div className="max-w-4xl mx-auto prose prose-lg">
      ...
      <div className="bg-white p-8 rounded-xl shadow-lg">
        ...
        <p className="text-gray-600 mb-6">
          By using banorcapital.com and our WhatsApp OTP authentication service, you agree to these Terms of Service and our Privacy Policy. These terms govern your use of services provided by Proxima Investment Management Limited, operating as BanorCapital.
        </p>
        ...
        <p className="text-gray-600 mb-4">
          • We provide secure login authentication through WhatsApp OTP delivery<br/>
        ...
        <p className="text-gray-600 mb-6">
          • Proxima Investment Management Limited (operating as BanorCapital) retains all rights to our platform and services<br/>
          • Users may not reproduce, distribute, or reverse engineer our authentication system<br/>
